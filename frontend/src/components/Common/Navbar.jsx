...
const Navbar = () => {
  ...
  return (
    ...
    <nav className='w-full max-w-none mx-auto flex items-center justify-between py-5 px-6 md:px-12 lg:px-24 bg-black'>
        ...
        {/*Left - Logo (Unchanged text "ELIX", styled white as in the image)*/}
        <div>
        ...
        {/*Center - Links (Now including Home first, styled white as in the image)*/}
        ...
        {/*Right - Icons in the EXACT order of the image: Search -> User -> Cart (Extremely small size: 16px)*/}
        <div className='flex items-center space-x-4 lg:space-x-6'>
            {user && user.role === "admin" && (  <Link
                to="/admin"
                className='block bg-white text-black px-2 py-0.5 rounded text-sm font-semibold hover:bg-gray-200 transition-colors'
                >
                    Admin
                </Link>)}
    ...
    {/* Mobile Drawer (Styled premium black & white) */}
    <div
