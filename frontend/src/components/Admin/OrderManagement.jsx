                ...
                <tr key={order._id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-4">
                    ...
                    <select
                      ...
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 outline-none cursor-pointer"
                    >
